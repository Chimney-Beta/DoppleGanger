...
import static com.app.thomasrogers.cardsaver.data.CardContract.CardEntry.TABLE_NAME;
...
public class CardContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         */
        uriMatcher.addURI(CardContract.AUTHORITY, CardContract.PATH_CARDS, CARDS);
        uriMatcher.addURI(CardContract.AUTHORITY, CardContract.PATH_CARDS + "/#", CARD_WITH_ID);
    ...
    public boolean onCreate() {
        ...
        mCardDbHelper = new CardDbHelper(context);
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        final SQLiteDatabase db = mCardDbHelper.getWritableDatabase();
        ...
        switch (match) {
            case CARDS:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(CardContract.CardEntry.CONTENT_URI, id);
                } else {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        final SQLiteDatabase db = mCardDbHelper.getReadableDatabase();
